...
public class Product {
    ...
    public static ObservableList<Product> getAllSearchedProducts(String  search_text)
    {
        String selectAllProducts="SELECT * FROM product where name like '%"+search_text+"%';";
        return fetchProductData(selectAllProducts);
    }
